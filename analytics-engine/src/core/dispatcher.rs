...
pub fn get_supported_algorithms() -> Vec<AlgorithmInfo> {
    let mut algorithms = vec![
        ...
        AlgorithmInfo {
            name: "mode".to_string(),
            description: "Calculate mode (most frequent values)".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
        AlgorithmInfo {
            ...
            description: "Calculate skewness (asymmetry measure)".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
        AlgorithmInfo {
            ...
            description: "Calculate kurtosis (tail heaviness measure)".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
        AlgorithmInfo {
            name: "q1".to_string(),
            description: "Calculate first quartile (25th percentile)".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
        AlgorithmInfo {
            name: "q3".to_string(),
            description: "Calculate third quartile (75th percentile)".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
        AlgorithmInfo {
            name: "iqr".to_string(),
            description: "Calculate interquartile range (Q3 - Q1)".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
        AlgorithmInfo {
            ...
            description: "Count number of data points".to_string(),
            implementations: vec!["rust".to_string()],
            required_params: vec![],
            optional_params: vec![],
        },
