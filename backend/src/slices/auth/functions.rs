...
pub async fn http_login(req: LoginRequest) -> HttpResponse<LoginResponse> {
    // 从依赖注入容器获取服务
    type AuthServiceType = super::service::JwtAuthService<super::service::MemoryUserRepository, super::service::MemoryTokenRepository>;
...
mod tests {
    use super::*;
    use crate::slices::auth::service::{MemoryUserRepository, MemoryTokenRepository};
