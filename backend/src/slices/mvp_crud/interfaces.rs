use super::types::{
    CreateItemRequest, CreateItemResponse, CrudResult, DeleteItemResponse, GetItemResponse, Item,
    ListItemsQuery, ListItemsResponse, UpdateItemRequest, UpdateItemResponse,
};
...
pub trait CrudService: Send + Sync + Clone {
    ...
    /// 更新项目
    async fn update_item(&self, id: &str, req: UpdateItemRequest)
